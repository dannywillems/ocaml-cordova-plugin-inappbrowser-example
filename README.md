...
This is an example of the binding to the *inappbrowser cordova plugin*. See the
...
* init_plugins: initialize plugins you need. Contains cordova-plugin-inappbrowser
  for this project.
